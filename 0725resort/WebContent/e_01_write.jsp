...
<meta http-equiv="refresh" content="0.1; url=?contentPage=e_01_view.jsp&key=<%=newid%>"> 
<%} else if(board_id.equals("2")) { %>
<meta http-equiv="refresh" content="0.1; url=?contentPage=e_02_view.jsp&key=<%=newid%>"> 
<%} %>
<body>
</body>
</html>