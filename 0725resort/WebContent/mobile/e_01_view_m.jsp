...
<%
	...
	ResultSet rset = stmt.executeQuery("select id,title,date,viewcnt,content,imgurl from resortboarditem where id="+id+";");
%>
<style>
img {
 max-width: 100%;
...
<table>
		<tr>
		<td><button class="btn btn-dark" type="button" onclick="location.href='e_01_m.jsp'">목록</button>		
		<%
		    String loginOK=null;
			...
			<button class="btn btn-dark" type="button" onclick="location.href='e_01_delete_m.jsp?key=<%=id %>&board=1'">삭제</button>
			<%}  %>
			</td>			
		</tr>
		</table>
